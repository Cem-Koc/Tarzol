    ...
    public partial class mig123 : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CategoryAndSubCategories", x => new { x.CategoryID, x.SubCategoryID });
                    table.ForeignKey(
                        name: "FK_CategoryAndSubCategories_Categories_CategoryID",
                        column: x => x.CategoryID,
                        principalTable: "Categories",
                        principalColumn: "ID");
                    table.ForeignKey(
                        name: "FK_CategoryAndSubCategories_SubCategories_SubCategoryID",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EstimatedDelivreyDate = table.Column<DateTime>(nullable: true),
                    DelivreyDate = table.Column<DateTime>(nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DiscountedPrice = table.Column<decimal>(type: "decimal(18,4)", nullable: false),
                    ...
                    ImageFour = table.Column<string>(nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    WasDelivered = table.Column<bool>(nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ModifiedBy = table.Column<string>(nullable: true),
                    Status = table.Column<int>(nullable: false),
                    ProductRatingPoint = table.Column<int>(nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CategoryAndSubCategories_SubCategoryID",
                table: "CategoryAndSubCategories",
